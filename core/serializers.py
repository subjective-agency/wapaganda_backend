...
class PagingRequestSerializer(CommonRequestSerializer):
    ...
    type = serializers.CharField(default='page', read_only=True)
    page = serializers.IntegerField(required=True, read_only=True, min_value=1)
    page_size = serializers.IntegerField(required=True, read_only=True, min_value=10, max_value=100)
