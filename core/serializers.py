...
class PeopleExtendedSerializer(serializers.Serializer):
    ...
    associates = serializers.JSONField(allow_blank=True, allow_null=True)
    ...
    aliases = serializers.JSONField(allow_blank=True, allow_null=True)
    ...
    bundles = serializers.JSONField(allow_blank=True, allow_null=True)
    ...
    orgs = serializers.JSONField(allow_blank=True, allow_null=True)
    # orgs = serializers.ListField(child=serializers.JSONField(allow_blank=True, allow_null=True))
    telegram_channels = serializers.JSONField(allow_blank=True, allow_null=True)
    # telegram_channels = serializers.ListField(child=serializers.JSONField(allow_blank=True, allow_null=True))
    youtube_channels = serializers.JSONField(allow_blank=True, allow_null=True)
